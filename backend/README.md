...
## Project Structure
    ...
    ├── testapiautoconnect_115774  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_115774`
...
2. Clone this repo and `cd testapiautoconnect_115774`
